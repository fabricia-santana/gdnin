...
app.controller('contactsController', function ($scope, $http)
{
    ...
    $scope.url = "/gdnin/protected/demandas/";
    ...
    $scope.populateTable = function (data) {
        if (data.pagesCount > 0) {
            ...
            $scope.page = {source: data.contacts, currentPage: $scope.pageToGet, pagesCount: data.pagesCount, totalDemandas : data.totalDemandas};
